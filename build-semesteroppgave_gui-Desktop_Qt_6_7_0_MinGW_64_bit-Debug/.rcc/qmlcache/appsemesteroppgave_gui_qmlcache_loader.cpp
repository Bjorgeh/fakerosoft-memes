...
namespace _qt_qml_semesteroppgave_gui_Main_qml { 
...
namespace _qt_qml_semesteroppgave_gui_defaultpage_StartPage_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appsemesteroppgave_gui)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appsemesteroppgave_gui))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appsemesteroppgave_gui)() {
    return 1;
}
